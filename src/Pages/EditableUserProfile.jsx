...
import { months, calcButtonTextColor } from './Sucess/tools'
...
function EditableUserProfile({
    ...
    return <>
        ...
        <Group>            
            ...
            <select value={month} onChange={e => setMonth(bound(e.target.value, 0, 11))} >
                {renderMonthOptions()}
            </select>
            <input type='number' value={day}  onChange={e => setDay(bound(e.target.value, 1, maxDay))}style={{width: "50px"}} />
        </Group>
        <Group>            
